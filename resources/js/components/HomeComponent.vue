...
<section class="pt-4 pb-0 card-grid">
	<div class="container-fluid">
		<div class="row g-4">
			<div>
                <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>Actualités a la Une</h2>
                <p>Ne Manquez pas nos  actualites a la une.</p>
            </div>
			<div class="col-lg-6">
		...
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<div class="mb-4">
					...
					<p>Les actualites sur la politique au TOGO</p>
				</div>
            ...
            <div class="col-lg-4">
                <!-- Top highlights START -->
				<div class="mb-4">
					<h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>FENETRE SUR L'AFRIQUE</h2>
					<p>Ouvrons une fenetre sur la politique au TOGO</p>
				</div>
                <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
                <div>
                    <div class="col-12 col-md-6">
...
<section class="pt-0 card-grid">
    ...
    <div class="mb-4">
        ...
        <p>Nos actualites a ne pas manquer au TOGO</p>
    </div>
    <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
		<div class="row">
			<div class="col-12">
...
<section class="pt-4 pb-0 card-grid">
	<div class="container-fluid">
		<div class="row g-4">
			<div >
                <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>SPORT</h2>
                <p>Nos actualites Sportives</p>
            </div>
            <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
			<div class="col-lg-6">
				<div class="tiny-slider arrow-hover arrow-blur arrow-white arrow-round rounded-3 overflow-hidden">
	...
	<div class="container-fluid" data-sticky-container>
		<div class="row">
			...
			<div class="col-lg-12">
				<!-- Top highlights START -->
				<div class="mb-4">
					<h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>SOCIETE</h2>
					<p>Les actualites sur notre societe au TOGO</p>
				</div>
                <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
				<div class="tiny-slider arrow-blur arrow-round rounded-3">
					<div class="tiny-slider-inner"
...
<section class="pt-4 pb-0 card-grid">
	<div class="container-fluid">
		<div class="row g-4">
			<div >
                <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>OPINION</h2>
                <p>Nous vous montrons les opinions concernant l'actualite </p>
            </div>
            <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
			<div class="col-lg-6">
				<div class="tiny-slider arrow-hover arrow-blur arrow-white arrow-round rounded-3 overflow-hidden">
...
<section class="pt-4">
	<div class="container-fluid">
        <div class="mb-4">
            <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>ARTICLES RECENTS </h2>
            <p>Les actualites recentes</p>
        </div>
        <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
		<div class="row">
			<div class="col-md-12">
...
<section class="pt-0 card-grid">
	<div class="container-fluid">
    <div class="mb-4">
        <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>IMPORTANT</h2>
        <p>Nos actualites importantes</p>
    </div>
    <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
		<div class="row">
			<div class="col-12">
...
<section class="pt-4">
	<div class="container-fluid">
        <div class="mb-4">
            <h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>FAITS DIVERS</h2>
            <p>Les actualites sur les faits divers</p>
        </div>
        <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
		<div class="row">
			<div class="col-md-12">
	...
	<div class="container-fluid" data-sticky-container>
		<div class="row">
        	<div class="col-lg-4">
                <!-- Top highlights START -->
				<div class="mb-4">
					<h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>Les plus lus</h2>
				</div>
                <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
                <div>
                    <div class="col-12 col-md-6">
            ...
            <div class="col-lg-4">
                <!-- Top highlights START -->
				<div class="mb-4">
					<h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>Les plus commentes</h2>
				</div>
                <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
                <div>
                    <div class="col-12 col-md-6">
            ...
            <div class="col-lg-4">
                <!-- Top highlights START -->
				<div class="mb-4">
					<h2 class="m-0"><i class="bi bi-hourglass-top me-2"></i>DIRECT</h2>
				</div>
                <div class="border-bottom border-primary border-2 opacity-1 my-4"></div>
                <div>
                    <div class="col-12 col-md-6">
