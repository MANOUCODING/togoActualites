		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" href="#" id="homeMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Accueil</a>
					...
					<!-- Nav item 2 Pages -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">TOGO</a>
					...
					<li class="nav-item dropdown dropdown-fullwidth">
						<a class="nav-link dropdown-toggle" href="#" id="megaMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">INFOS PRATIQUES</a>
                    ...
                    <!-- Nav item 5 link-->
					<li class="nav-item"> <a class="nav-link" href="dashboard.html">CATEGORIES</a></li>
			...
			<div class="nav flex-nowrap align-items-center">
				...
				<div class="nav-item d-none d-md-block">
					<router-link to="/register" class="btn btn-sm btn-danger mb-0 mx-2">S'inscrire!</router-link>
				</div>
				<!-- Nav Search -->
