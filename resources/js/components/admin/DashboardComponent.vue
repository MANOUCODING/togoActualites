		...
		<div class="row g-4">
			...
			<div class="col-md-6 col-xxl-4">
				...
				<div class="card border h-100">
					...
					<div class="card-header border-bottom p-3">
						<h5 class="card-header-title mb-0">Les actualités à la une</h5>
					</div>
			...
			<div class="col-md-6 col-xxl-4">
				...
				<div class="card border h-100">
					<!-- Card header -->
					<div class="card-header border-bottom p-3">
						<h5 class="card-header-title mb-0">les actualités plus visitées</h5>
					</div>
			...
			<div class="col-md-6 col-xxl-4">
				...
				<div class="card border h-100">
					...
					<div class="card-header border-bottom d-flex justify-content-between align-items-center  p-3">
						<h5 class="card-header-title mb-0">Les  actualités  plus aimées</h5>
            <!-- Dropdown button -->
			...
			<div class="col-md-6 col-xxl-4">
				...
				<div class="card border h-100">
					<!-- Card header -->
					<div class="card-header border-bottom d-flex justify-content-between align-items-center  p-3">
						<h5 class="card-header-title mb-0">Les actualités  plus commentées</h5>
            <!-- Dropdown button -->
						<div class="dropdown text-end">
							<a href="#" class="btn border-0 p-0 mb-0" role="button" id="dropdownShare3" data-bs-toggle="dropdown" aria-expanded="false">
								<i class="bi bi-three-dots fa-fw"></i>
