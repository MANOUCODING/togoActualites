				...
				<div class="card border bg-transparent rounded-3">
					...
					<div class="card-header bg-transparent border-bottom p-3">
						<div class="d-sm-flex justify-content-between align-items-center">
							<h5 class="mb-2 mb-sm-0">Statistiques sur les utilisateurs <span class="badge bg-primary bg-opacity-10 text-primary">{{ infos.usersCount  }}</span></h5>
						</div>
					</div>
					<!-- Card header END -->
							...
							<table class="table align-middle p-4 mb-0 table-hover table-shrink">
								...
								<thead class="table-dark">
									<tr>
										...
										<th scope="col" class="border-0">Nombres d'utilisateurs</th>
                  ...
                  <tr>
                    ...
                    <th scope="col">{{ infos.countNewsLattersJ  }} utilisateur(s)</th>
										<!-- Table data -->
										<td>
                      <div class="d-flex gap-2">
                          <a href="#" class="btn btn-primary btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir les articles consultes"><i class="bi bi-eye"></i></a>
                      </div>
										</td>
									</tr>
                  ...
                  <tr>
                      ...
                      <th scope="col">{{ infos.countNewsLattersW  }} utilisateur(s)</th>
										<!-- Table data -->
										<td>
                      <div class="d-flex gap-2">
                        <a href="#" class="btn btn-primary btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir les articles consultes"><i class="bi bi-eye"></i></a>
                  ...
                  <tr>
                    ...
                    <th scope="col">{{ infos.countNewsLattersM  }} utilisateur(s)</th>
										<!-- Table data -->
										<td>
                      <div class="d-flex gap-2">
                          <a href="#" class="btn btn-primary btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir les articles consultes"><i class="bi bi-eye"></i></a>
                  ...
                  <tr>
                    <th scope="col">4</th>
                    <th scope="col">Totale des utilisateurs</th>
                    <th scope="col">{{ infos.usersCount  }} utilisateur(s)</th>
										<!-- Table data -->
										<td>
                      <div class="d-flex gap-2">
                          <a href="#" class="btn btn-primary btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir les articles consultes"><i class="bi bi-eye"></i></a>
