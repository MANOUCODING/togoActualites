    ...
    <div class="col-12" v-if="addCategoryButton">
      ...
      <div class="col-12">
				...
				<div class="card border bg-transparent rounded-3">
					...
					<div class="card-header bg-transparent border-bottom p-3">
						<div class="d-sm-flex justify-content-between align-items-center">
							<h5 class="mb-2 mb-sm-0">Articles par categorie <span class="badge bg-primary bg-opacity-10 text-primary">{{ infos.categoryCount  }}</span></h5>
...
export default {
  ...
  methods: {
    getResults(page = 1){
      axios
        .get('/api/articles/by/category?page=' + page)
        .then(response => {
          this.load = false
